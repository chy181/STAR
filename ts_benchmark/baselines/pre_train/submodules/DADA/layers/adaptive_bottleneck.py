...
class BottleNeck(nn.Module):
    ...
    def forward(self, repr, c=0): # b*c x pN*repr_dim
        """
...
class AdaptiveBottleNeck(nn.Module):
    ...
    def forward(self, router_input, repr, loss_coef=1e-2, c=0):
        """Args:
        ...
        outputs = [self.bottlenecks[i](inputs[i],c=c) for i in range(self.num_bottlenecks)]
