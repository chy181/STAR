...
from ts_benchmark.baselines.pre_train.submodules.moment.momentfm.models.moment import MOMENTPipeline
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model = MOMENTPipeline.from_pretrained(
            ...
            "ts_benchmark/baselines/pre_train/checkpoints/moment-small",
            model_kwargs={
